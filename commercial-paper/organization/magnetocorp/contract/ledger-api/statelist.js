...
class StateList {
    ...
    constructor(ctx, listName) {
        ...
        console.log("[DEBUG] in StateList.constructor(...)");
    }
    ...
    async addState(state) {
        console.log("[DEBUG] in StateList.addState()");
     ...
     */
    async getState(key) {
        console.log("[DEBUG] in StateList.getState()");
    ...
    async updateState(state) {
        console.log("[DEBUG] in StateList.updateState()");
        let key = this.ctx.stub.createCompositeKey(this.name, state.getSplitKey());
        let data = State.serialize(state);
        await this.ctx.stub.putState(key, data);
    }
    ...
    use(stateClass) {
        console.log("[DEBUG] in StateList.use(stateClass)");
