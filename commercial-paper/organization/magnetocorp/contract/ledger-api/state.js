...
class State {
    ...
    constructor(stateClass, keyParts) {
        ...
        console.log("[DEBUG] in State.constructor()");
    }
    ...
    getSplitKey(){
        console.log("[DEBUG] in State.getSplitKey()");
    ...
    serialize() {
        console.log("[DEBUG] in State.serialize()");
    ...
    static serialize(object) {
        console.log("[DEBUG] in State.serialize(object)");
    ...
    static deserialize(data, supportedClasses) {
        console.log("[DEBUG] in State.deserialize(data, supportedClasses");
    ...
    static deserializeClass(data, objClass) {
        console.log("[DEBUG] in State.deserializeClass(data, objClass)");
        let json = JSON.parse(data.toString());
        let object = new (objClass)(json);
        return object;
    }
